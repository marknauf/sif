(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/ReplaySubject'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('rxjs/operators/map'), require('rxjs/operators/filter'), require('rxjs/operators/pairwise'), require('rxjs/operators/distinctUntilChanged'), require('rxjs/operators/startWith'), require('rxjs/operators/share'), require('@angular/forms'), require('@angular/router'), require('rxjs/operators/takeWhile'), require('@angular/platform-browser'), require('rxjs/observable/of'), require('rxjs/observable/combineLatest'), require('rxjs/operators/delay'), require('rxjs/observable/fromEvent'), require('rxjs/observable/empty'), require('rxjs/operators/debounceTime'), require('rxjs/operators/switchMap'), require('rxjs/operators/repeat'), require('rxjs/operators/takeUntil')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/ReplaySubject', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'rxjs/operators/map', 'rxjs/operators/filter', 'rxjs/operators/pairwise', 'rxjs/operators/distinctUntilChanged', 'rxjs/operators/startWith', 'rxjs/operators/share', '@angular/forms', '@angular/router', 'rxjs/operators/takeWhile', '@angular/platform-browser', 'rxjs/observable/of', 'rxjs/observable/combineLatest', 'rxjs/operators/delay', 'rxjs/observable/fromEvent', 'rxjs/observable/empty', 'rxjs/operators/debounceTime', 'rxjs/operators/switchMap', 'rxjs/operators/repeat', 'rxjs/operators/takeUntil'], factory) :
	(factory((global.nb = global.nb || {}, global.nb.theme = global.nb.theme || {}),global.ng.core,global.ng.common,global.Rx,global.Rx,global.Rx,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.ng.forms,global.ng.router,global.Rx.operators,global.ng.platformBrowser,global.Rx.Observable,global.Rx.Observable,global.Rx.operators,global.Rx.Observable,global.Rx.Observable,global.Rx.operators,global.Rx.operators,global.Rx.operators,global.Rx.operators));
}(this, (function (exports,_angular_core,_angular_common,rxjs_ReplaySubject,rxjs_Subject,rxjs_BehaviorSubject,rxjs_operators_map,rxjs_operators_filter,rxjs_operators_pairwise,rxjs_operators_distinctUntilChanged,rxjs_operators_startWith,rxjs_operators_share,_angular_forms,_angular_router,rxjs_operators_takeWhile,_angular_platformBrowser,rxjs_observable_of,rxjs_observable_combineLatest,rxjs_operators_delay,rxjs_observable_fromEvent,rxjs_observable_empty,rxjs_operators_debounceTime,rxjs_operators_switchMap,rxjs_operators_repeat,rxjs_operators_takeUntil) { 'use strict';
...
var NbLayoutComponent = /** @class */ (function () {
    function NbLayoutComponent(themeService, spinnerService, componentFactoryResolver, elementRef, renderer, router, window, document, platformId) {
        var _this = this;
    ...
    NbLayoutComponent.decorators = [
        { type: _angular_core.Component, args: [{
                    selector: 'nb-layout',
                    styles: [":host{-webkit-font-smoothing:antialiased}:host .layout{display:flex;flex-direction:column}:host /deep/ nb-layout-header{display:block}:host /deep/ nb-layout-header nav{align-items:center;justify-content:flex-start;display:flex}:host /deep/ nb-layout-header.fixed{position:fixed;left:0;right:0;z-index:1040}:host .layout-container{display:flex;flex:1;-ms-flex:1 1 auto;flex-direction:row}:host .layout-container /deep/ nb-sidebar{order:0}:host .layout-container /deep/ nb-sidebar.right{order:2}:host .layout-container /deep/ nb-sidebar .fixed{position:fixed;width:100%;overflow-y:auto;height:100%}:host .layout-container .content{display:flex;flex:1;-ms-flex:1 1 auto;flex-direction:column;min-width:0}:host .layout-container .content.center{max-width:100%;position:relative;margin-left:auto;margin-right:auto}:host .layout-container .content .columns{display:flex;flex:1;-ms-flex:1 1 auto;flex-direction:row;width:100%}:host .layout-container .content .columns /deep/ nb-layout-column{order:2;flex:1 0;min-width:0}:host .layout-container .content .columns /deep/ nb-layout-column.left{order:1}:host .layout-container .content /deep/ nb-layout-footer{display:block;margin-top:auto}:host .layout-container .content /deep/ nb-layout-footer nav{justify-content:center;display:flex} "],
...
var NbMenuComponent = /** @class */ (function () {
    ...
    NbMenuComponent.prototype.ngOnInit = function () {
        ...
        this.menuInternalService
            .onAddItem()
            .pipe(rxjs_operators_takeWhile.takeWhile(function () { return _this.alive; }), rxjs_operators_filter.filter(function (data) { return _this.compareTag(data.tag); }))
...
var NbSearchComponent = /** @class */ (function () {
    function NbSearchComponent(searchService, themeService, router) {
        ...
        this.showSearch = false;
        this.searchFieldComponentRef$ = new rxjs_BehaviorSubject.BehaviorSubject(null);
    ...
    NbSearchComponent.prototype.ngOnInit = function () {
        ...
        this.activateSearchSubscription = rxjs_observable_combineLatest.combineLatest([
            this.searchFieldComponentRef$,
            this.searchService.onSearchActivate(),
        ])
            .pipe(rxjs_operators_takeWhile.takeWhile(function () { return _this.alive; }), rxjs_operators_filter.filter(function (_a) {
        ...
        this.deactivateSearchSubscription = rxjs_observable_combineLatest.combineLatest([
            this.searchFieldComponentRef$,
...
var NB_TRIGGERS = (_a$2 = {},
    ...
    function (host, getContainer, document) {
        return {
            open: rxjs_observable_empty.empty(),
            close: rxjs_observable_fromEvent.fromEvent(document, 'click')
            ...
            toggle: rxjs_observable_fromEvent.fromEvent(host, 'click'),
        };
    },
    /**
    ...
    function (host, getContainer, document) {
        return {
            open: rxjs_observable_fromEvent.fromEvent(host, 'mouseenter')
                .pipe(rxjs_operators_delay.delay(100), rxjs_operators_takeUntil.takeUntil(rxjs_observable_fromEvent.fromEvent(host, 'mouseleave')), rxjs_operators_repeat.repeat()),
            close: rxjs_observable_fromEvent.fromEvent(host, 'mouseleave')
                .pipe(rxjs_operators_switchMap.switchMap(function () {
                return rxjs_observable_fromEvent.fromEvent(document, 'mousemove')
                    .pipe(rxjs_operators_debounceTime.debounceTime(100), rxjs_operators_takeWhile.takeWhile(function () { return !!getContainer(); }), rxjs_operators_filter.filter(function (event) {
                    return !host.contains(event.target)
                        && !getContainer().location.nativeElement.contains(event.target);
                }));
            })),
            toggle: rxjs_observable_empty.empty(),
        };
    },
    /**
     * Creates open and close events streams based on popover {@link NbPopoverMode#HOVER} mode.
...
var NbPopoverDirective = /** @class */ (function () {
    function NbPopoverDirective(hostRef, themeService, componentFactoryResolver, positioningHelper, adjustmentHelper, triggerHelper, platformId) {
    ...
    function () {
        ...
        open.pipe(rxjs_operators_takeWhile.takeWhile(function () { return _this.alive; }))
            .subscribe(function () { return _this.show(); });
        close.pipe(rxjs_operators_takeWhile.takeWhile(function () { return _this.alive; }))
            .subscribe(function () { return _this.hide(); });
        toggle.pipe(rxjs_operators_takeWhile.takeWhile(function () { return _this.alive; }))
...
var NbContextMenuDirective = /** @class */ (function () {
    function NbContextMenuDirective(hostRef, themeService, componentFactoryResolver, positioningHelper, adjustmentHelper, triggerHelper, platformId) {
        this.context = {};
        /**
             * Initialize popover with all the important inputs.
             * */
        this.popover = new NbPopoverDirective(hostRef, themeService, componentFactoryResolver, positioningHelper, adjustmentHelper, triggerHelper, platformId);
