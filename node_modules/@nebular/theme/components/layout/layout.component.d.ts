...
export declare class NbLayoutComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    private alive;
    constructor(themeService: NbThemeService, spinnerService: NbSpinnerService, componentFactoryResolver: ComponentFactoryResolver, elementRef: ElementRef, renderer: Renderer2, router: Router, window: any, document: any, platformId: Object);
